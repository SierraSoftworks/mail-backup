# Telemetry
Mail Backup is designed to run as an unattended backup system, requiring minimal
...
By default Mail Backup will export its telemetry data to the console in a human
...
configure Mail Backup to send its telemetry data to your Honeycomb account by setting
...
configure Mail Backup to send its telemetry data to your Grafana Cloud account by setting
the following environment variables.
